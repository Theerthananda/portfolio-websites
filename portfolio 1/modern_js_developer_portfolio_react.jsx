...
// Replace all information marked with comments
// ===============================
    ...
    <div className="min-h-screen bg-black text-white font-sans overflow-x-hidden relative">
      ...
      <section className="relative min-h-screen flex items-center justify-center px-6 text-center">
        <div className="max-w-4xl z-10">
          ...
          <p className="text-gray-400 max-w-2xl mx-auto leading-relaxed text-lg mb-10">
            I build responsive, modern, and interactive web applications with clean UI,
            smooth user experiences, and scalable backend systems.
          </p>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-5">
            ...
            <a
              href="/D:\PortFolio\Theerthananda CV.pdf"
      ...
      <section id="about" className="py-24 px-6">
        <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-12 items-center">
          <div>
            <div className="w-72 h-72 rounded-3xl bg-gradient-to-br from-cyan-500 to-purple-600 mx-auto shadow-2xl shadow-cyan-500/20"></div>
          </div>
          ...
          <div>
            ...
            <p className="text-gray-400 leading-relaxed text-lg mb-6">
              I enjoy building clean, interactive, and responsive web applications using
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-10">
            <div className="rounded-3xl overflow-hidden border border-white/10 bg-black/40 shadow-2xl">
              <img
                src="D:\PortFolio\SDM-College3-1-scaled.jpg"
                alt="SDM College"
      ...
      <footer className="border-t border-white/10 py-8 text-center text-gray-500 text-sm">
        © 2026 Theerthananda. Built with React & Tailwind CSS.
      </footer>
    </div>
  );
}
